...
<section class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col" style="max-height: calc(100vh - 200px);">
        ...
        <table class="w-full text-left border-collapse min-w-[1500px]">
            ...
            <thead class="sticky top-0 z-10 bg-blue-50">
                ...
                <tr class="bg-blue-50 text-gray-600 text-xs uppercase font-bold">
                    ...
                    <th class="p-4 border-b bg-blue-50 sticky left-0 z-30 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] w-[200px]">Usuário (ERP)</th>
                    ...
                    <th class="p-4 border-b text-center">Venda Prod.Cliente</th>
                    ...
                    <th class="p-4 border-b bg-blue-50 sticky right-[100px] z-30 shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.1)] w-[150px]">Nova Senha</th>
                    <th class="p-4 border-b bg-blue-50 text-center sticky right-0 z-30 shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.1)] w-[100px]">Ações</th>
            ...
            <tbody class="text-sm text-gray-700">
                ...
                <tr class="border-b hover:bg-gray-50 transition">
                    ...
                    <form action="{{ route('users.update', $user->codigo_acesso) }}" method="POST">
                        ...
                        <td class="p-4 text-center">
                            <input type="checkbox" name="vendas_showroom" value="1" {{ (int)$user->vendas_showroom === 1 ? 'checked' : '' }} class="w-4 h-4 text-orange-500">
                        </td>
                        ...
                        <td class="p-4 text-center">
                            <input type="checkbox" name="consulta_prod_cli" value="1" {{ (int)($user->consulta_prod_cli ?? 0) === 1 ? 'checked' : '' }} class="w-4 h-4 text-green-600">
                        </td>
