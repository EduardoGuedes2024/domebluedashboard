...
@section('title', 'Ranking de Vendas Rio De Janeiro - DomeBlue')
...
<header class="mb-6 bg-blue-50 p-6 rounded-xl shadow-sm border border-gray-200">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        ...
        <form method="GET" action="{{ route('vendas_Rio') }}" id="formVendas" class="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:items-end gap-3">
            ...
            <div class="flex gap-2">
                ...
                {{--- Botao limpar---}}
                <a href="{{ route('vendas_Rio') }}" class="bg-slate-200 text-slate-700 px-4 py-2 rounded-lg font-bold hover:bg-slate-300 transition">
                    Limpar
                </a>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
    ...
    <div class="bg-white p-5 rounded-xl border border-blue-100 shadow-sm flex items-center gap-4">
        ...
        <div class="w-12 h-12 bg-green-100 text-greem-600 rounded-full flex items-center justify-center text-xl">
            <i class="fa-solid fa-dollar-sign"></i>
        </div>

        <div>
            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                Faturamento RJ no período filtrado 
                ...
                <div class="px-3 py-4 bg-slate-50 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="text-[13px] font-black px-3 py-1 bg-slate-800 text-white rounded-full">
                            RANK Rio: #{{ $loop->iteration + ($pagination->firstItem() - 1) }}
                        </span>
                    </div>
                </div>
