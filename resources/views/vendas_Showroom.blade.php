...
@section('title', 'Ranking de Vendas Showroom - DomeBlue')
...
<header class="mb-6 bg-blue-50 p-6 rounded-xl shadow-sm border border-gray-200">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Vendas - Showroom</h1>
            <p class="text-gray-500 text-sm">Ranking de produtos ordenados por volume de saída no Showroom</p>
        </div>

        <form method="GET" action="{{ route('vendas_Showroom') }}" id="formVendas" class="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:items-end gap-3">
            ...
            <div class="flex gap-2">
                ...
                {{--- Botao limpar---}}
                <a href="{{ route('vendas_Showroom') }}" class="bg-slate-200 text-slate-700 px-4 py-2 rounded-lg font-bold hover:bg-slate-300 transition">
                    Limpar
                </a>
...
@if(empty($cards))
    <div class="bg-white p-12 rounded-xl border border-blue-100 text-center shadow-sm">
        ...
        <p class="text-blue-600 font-bold mt-2">Selecione o período para ver o que o Showroom mais vendeu.</p>
    </div>
@else
    ...
    <div class="bg-white p-5 rounded-xl border border-blue-100 shadow-sm flex items-center gap-4">
        ...
        <div>
            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                Faturamento Estimado no SHOWROOM no Período Filtrado
                ...
                <div class="px-3 py-4 bg-slate-50 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="text-[13px] font-black px-3 py-1 bg-slate-800 text-white rounded-full">
                            RANK Showroom: #{{ $loop->iteration + ($pagination->firstItem() - 1) }}
                        </span>
