...
<?php $__env->startSection('title', 'Ranking de Vendas Atacado - DomeBlue'); ?>
...
<div id="loader-overlay" style="display: none; position: fixed; inset: 0; background: rgba(255,255,255,0.9); z-index: 9999; align-items: center; justify-content: center; cursor: wait;">
    <div class="flex flex-col items-center">
        ...
        <h3 class="text-blue-900 font-black mt-4">PROCESSANDO VENDAS Atacado</h3>
        <p class="text-slate-500 text-sm">Analisando performance exclusiva da unidade Atacado...</p>
    </div>
</div>
...
<header class="mb-6 bg-blue-50 p-6 rounded-xl shadow-sm border border-gray-200">
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Vendas - Atacado</h1>
            <p class="text-gray-500 text-sm">Ranking de produtos ordenados por volume de saída nesta loja</p>
        </div>

        <form method="GET" action="<?php echo e(route('vendas_Atacado')); ?>" id="formVendas" class="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:items-end gap-3">
            <div>
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('vendas_Atacado')); ?>" class="bg-slate-200 text-slate-700 px-4 py-2 rounded-lg font-bold hover:bg-slate-300 transition">
                    Limpar
                </a>
            </div>
        </form>
...
<?php if(empty($cards)): ?>
    <div class="bg-white p-12 rounded-xl border border-blue-100 text-center shadow-sm">
        ...
        <p class="text-blue-600 font-bold mt-2">Selecione o período para ver o que o Atacado mais vendeu.</p>
    </div>
<?php else: ?>
    <div class="space-y-6">
                ...
                <div class="px-6 py-4 bg-slate-50 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="text-[13px] font-black px-3 py-1 bg-slate-800 text-white rounded-full">
                            RANK Atacado: #<?php echo e($loop->iteration + ($pagination->firstItem() - 1)); ?>
                                ...
                                <table class="w-full text-sm">
                                    <thead class="bg-slate-100 border-b">
                                        <tr class="text-slate-500 text-[10px] uppercase font-black">
                                            ...
                                            <th class="px-4 py-3 text-center bg-blue-50 text-blue-700 font-black w-48">Vendas Realizadas no Atacado</th>
                                        </tr>
                                    </thead>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\domeblue-dash\resources\views/vendas_Atacado.blade.php ENDPATH**/ ?>